        ...
        lessons: [
            ...
            },
            {
                ...
                vocabulary: [
                    ...
                    { term: '千', reading: 'qiān', meaning: 'Thousand' },
                ],
                grammarNotes: [
                    { title: 'Number Pattern', body: 'Chinese uses a base-10 system. 十 (shí) means ten, 百 (bǎi) means hundred, 千 (qiān) means thousand. Combine these with units to form any number.' },
                ],
            },
            {
                id: 'greetings',
    ...
    },
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                estimatedTime: '25 min',
                difficulty: 'Beginner',
                explanation: ['Lesson content being prepared.'],
                examples: [],
                audio: [],
                vocabulary: [],
                sentences: [],
