...
const Content = ({
    ...
    return (
        <div
            className={`absolute z-50 mt-2 rounded-md shadow-lg transition ease-out duration-200 opacity-100 scale-100 ${alignmentClasses} ${widthClasses}`}
            onClick={() => setOpen(false)}
        >
            <div
                className={
...
const DropdownLink = ({ className = '', children, to, onClick, as, ...props }) => {
    const baseClassName =
